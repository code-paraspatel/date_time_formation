          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                TextWidget(title: 'Time in AM',  date:DateFormat.jm().format(DateTime.now().copyWith(hour: 11))),
                ...
                Text("${DatesUtils().timesAndMinutesAgo(DateTime(2024, 02, 18 , 10 , 20).microsecondsSinceEpoch.toString())},${DatesUtils().timesAndMinutesAgo(DateTime(2024, 02, 19 , 17 , 20).microsecondsSinceEpoch.toString())},${DatesUtils().timesAndMinutesAgo(DateTime(2024, 02, 19 , 17 , 40,10).microsecondsSinceEpoch.toString())},${DatesUtils().timesAndMinutesAgo(DateTime(2024,02,19,14,10).microsecondsSinceEpoch.toString())}"),
                const Divider(),
                ...
                TextWidget(date: DatesUtils().compareTimesForSevenDays(DateTime(2024,02,19).microsecondsSinceEpoch.toString())),
                TextWidget(date: DatesUtils().compareTimesForSevenDays(DateTime(2024, 02, 17).microsecondsSinceEpoch.toString())),
...
class DatesUtils {
  ...
  String timesAndMinutesAgo(String timestamp){
    ...
    print(diff.inMinutes);
      ...
      time = diff.inHours.toString() +"hr ago";
